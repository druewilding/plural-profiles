...
ActiveRecord::Base.transaction do
  ...
  stray  = user.profiles.create!(name: "Stray",  pronouns: "they/them", heart_emojis: %w[13_storm_heart 26_shadow_heart],               description: "In Prism Circle & Rogue Pack — should NOT appear in Alpha Clan (excluded by profile override).", avatar_shape: "circle")
  ember  = user.profiles.create!(name: "Ember",  pronouns: "she/her",   heart_emojis: %w[29_blossom_heart 35_passionate_heart],         description: "In Prism Circle — SHOULD appear in Alpha Clan (selected in profile override).")
  drift  = user.profiles.create!(name: "Drift",  pronouns: "he/him",                                                                    description: "In Flux (direct) — should NOT appear in Castle Clan.")
  ripple = user.profiles.create!(name: "Ripple", pronouns: "they/she",  heart_emojis: %w[05_seafoam_heart 11_aqua_heart 22_mist_heart], description: "In Flux (direct) — should NOT appear in Castle Clan.")
  grove  = user.profiles.create!(name: "Grove",                                                                                         description: "Direct member of Alpha Clan.", avatar_shape: "square")
  shadow = user.profiles.create!(name: "Shadow", pronouns: "she/they",  heart_emojis: %w[28_inky_heart 32_void_heart],                  description: "Direct member of Castle Clan.", avatar_shape: "circle")
  mirage = user.profiles.create!(name: "Mirage", pronouns: "any/all",   heart_emojis: %w[23_lavender_heart 24_violet_heart],            description: "In Echo Shard — SHOULD appear in Castle Clan via Flux.")
  spark  = user.profiles.create!(name: "Spark",                         heart_emojis: %w[42_dawn_heart 50sunshine_heart],               description: "In Static Burst — should NOT appear in Castle Clan.")

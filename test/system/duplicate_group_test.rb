...
class DuplicateGroupTest < ApplicationSystemTestCase
  ...
  test "reversed label order still triggers conflict resolution" do
    # Set up state directly: duplicate Prism Circle with "black, white" via Ruby.
    # This avoids a full browser duplication flow that accumulates Chrome CDP stale state.
    prism = groups(:prism_circle)
    ...
    assert_no_text "Group question 1"
    ...
    assert_no_text "Group question 2"
    assert_text "Profile question 1"
    choose "Create a new copy"
    click_button "Next"

    assert_no_text "Profile question 1"
    assert_text "Profile question 2"
    choose "Create a new copy"
    click_button "Next"

    assert_no_text "Profile question 2"
    assert_text "Confirm duplication"
    click_button "Confirm and duplicate"
    assert_text "Group duplicated"
  end
